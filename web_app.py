...
def GetApi():
    return [(rgw_consts.Node_URLs.API_SYS_CFG, api_handlers.SysCfg),
...
def GetAPP():
    return [
        (rgw_consts.Node_URLs.APP_ADM_LOGIN, ui_handlers.AppAdmLogin),
        (rgw_consts.Node_URLs.APP_LOGOUT, ui_handlers.Logout),
        (rgw_consts.Node_URLs.APP_SYS_CFG, ui_handlers.AppSysCfg),
        (rgw_consts.Node_URLs.APP_SYS_CFG_MOBILE, ui_handlers.AppSysCfgMobile),
        (rgw_consts.Node_URLs.APP_ADM_SENSOR, ui_handlers.AppSensorAdm),
        (rgw_consts.Node_URLs.APP_EDIT_SENSOR, ui_handlers.AppEditSensor),
        (rgw_consts.Node_URLs.APP_EDIT_SENSOR_TRIGGER, ui_handlers.AppEditSensorTrigger),
...
def GetViewHandlers():
    return [
        (rgw_consts.Node_URLs.VIEW_SWITCH_SCHEDULES, ui_handlers.ViewSwitchSchedule),
        (rgw_consts.Node_URLs.VIEW_RECENT_HOURS_SENSOR_DATA_PLOTTING, plotting_handlers.SensorHourlyLogHandler),
        (rgw_consts.Node_URLs.VIEW_SENSOR_MINS_AVG_TREND, ui_handlers.ViewSensorMinsAvgTrend),
        (rgw_consts.Node_URLs.VIEW_SENSOR_MINS_AVG_DATA, ui_handlers.ViewSensorMinsAvgData),
        (rgw_consts.Node_URLs.VIEW_SWITCH_ON_LOG_DETAIL, ui_handlers.ViewSwitchOnLogDetail),
        (rgw_consts.Node_URLs.VIEW_SENSORS_RECENT_TREND, ui_handlers.ViewSensorRecentTrend),
        (rgw_consts.Node_URLs.VIEW_MONTHLY_SWITCH_USAGE, ui_handlers.ViewMonthlySwitchUsage)
    ]
